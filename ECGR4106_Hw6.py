...
# SECTION 1: Problem 1 - Vision Transformer
# Hyperparameters
image_size = 32
patch_size = 8
num_classes = 100
...
class PatchEmbedding(nn.Module):
    def __init__(self, image_size, patch_size, in_channels=3, embed_dim=128):
        super().__init__()
...
model = SwinForImageClassification(config=swin_config)
model.to(device)
